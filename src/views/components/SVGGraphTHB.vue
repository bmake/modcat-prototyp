...
export default {
  ...
  data() {
    return {
      svgfile: require("../../assets/THBgraphMod.svg"),
      gridSize: 100
      /*moduleInfo: [],
      modBasicData: [],‚
      modOutcomes: [],
        ...
        .on("click", function() {
          if (_this.role > 0) {
            ...
            if (
              ...
              d3.select("#nodeTHB").classed("selected", true);
              d3.select("#nodeFBW").classed("selected", true);
              d3.select("#nodeFBT").classed("selected", true);
              d3.select("#nodeFBI").classed("selected", true);
              d3.select("#layer1")
